                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                            ...
                                            <td>
                                                <form id="frm' . $snackId . '">
                                                    <input type="hidden" name="pizzaId" value="' . $snackId . '">
                                                    <input type="number" name="quantity" readonly value="' . $Quantity . '" class="text-center" onchange="updateCart(' . $snackId . ')" onkeyup="return false" style="width:60px" min=1 oninput="check(this)" onClick="this.select();">
                                                </form>
                                            </td>
                                            <td>' . $total . '</td>
                                            <td>
                                                <form action="manage_viewcart.php" method="POST">
                                                    ...
                                                    <input type="hidden" name="itemId" value="' . $snackId . '">
                                                </form>
                                            </td>
                                        </tr>';
                            }
            ...
            <div class="col-lg-5" style="margin-left: 30%;"><br>
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        <h5 class="mb-4 text-uppercase font-weight-bold text-center">Price Details</h5>
