<div class="panel panel-default">
    <div class="panel-body" id="disp"><?php
                                        ...
                                        $qq = mysqli_query($con, "select * from tbl_bookings where show_id='" . $swt['s_id'] . "' and date=CURDATE() and `status` = '1'");
            ...
            <table class="table">
                ...
                <?php
                                            ...
                                            while ($sh = mysqli_fetch_array($qq)) {
                                                $us = mysqli_query($con, "select * from registration where uid='" . $sh['user_id'] . "'");
